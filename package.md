...
| --- | --- | --- | --- | --- | --- | --- |
| Яролика (главная героиня) | Игровая сцена, меню | Главный персонаж, которым управляет игрок | Да | Нужен | 2D side-view, девушка с синими волосами и карими глазами, в широкой рубашке и шароварах, вид сбоку, стоит лицом вправо, пиксельный стиль, прозрачный фон | ![Яролика3.png](assets/asset_asset_1_яролика3.png) |
| Святозар (главный герой) | Игровая сцена, меню | Главный персонаж, которым управляет игрок | Да | Нужен | 2D side-view, парень со светлыми кудрявыми волосами и зелёными глазами, в голубой рубашке и чёрных шароварах, вид сбоку, стоит лицом вправо, пиксельный стиль, прозрачный фон | ![Святозар2](assets/asset_asset_2_святозар2.святозар2) |
| Леший | Игровая сцена | Даёт подсказки и мешает игроку | Да | Нужен | 2D side-view, маленький хитрый старичок в лохмотьях из листьев и мха, с хитрой улыбкой и прищуренными глазами, стоит, прозрачный фон | ![Леший2.jfif](assets/asset_asset_3_леший2.jfif) |
| Русалка | Игровая сцена | Враг, который пугает и мешает | Да | Нужен | 2D side-view, русалка с зелёными волосами, в лохмотьях, сидит, смотрит прямо, жуткая | ![русалка2.jfif](assets/asset_asset_4_русалка2.jfif) |
| Оборотень | Игровая сцена | Враг, который пугает | Да | Нужен | 2D side-view, волк на четырёх лапах, тёмная шерсть, жёлтые глаза, оскал, стоит, прозрачный фон | ![оборотень 2.png](assets/asset_asset_5_оборотень_2.png) |
| Части оберега | Игровая сцена (лежит на карте) и UI | Предметы для сбора и открытия прохода (корень, перо, коготь) | Да | Нужен | Три иконки на прозрачном фоне: корень с зелёными листьями, перо оранжево-красное, коготь белый длинный | ![Оберег.png](assets/asset_asset_6_оберег.png) |
| Кристаллы | Игровая сцена (лежит на карте) и UI (счётчик) | Валюта | Да | Нужен | Иконка голубо-синего кристалла, светится, на прозрачном фоне | ![кристалл.webp](assets/asset_asset_7_кристалл.webp) |
| Фон (Сумрачный лес) | Игровая сцена (фон) | Картинка заднего плана | Да | Нужен | Горизонтальный 2D-фон, тёмно-зелёный лес, деревья, трава, черепа на земле, без глубины, вид сбоку | ![шедевр.webp](assets/asset_asset_8_шедевр.webp) |
| UI-элементы | Все сцены (поверх игры) | то, что на карте. | Да | Нужен | иконки жизни, карта, порталы | ![ui-картинки.jfif](assets/asset_asset_9_ui-картинки.jfif) |
| Тайный проход (закрытый) | Игровая сцена (на карте) | Препятствие, которое надо открыть | Да | Нужен | Каменная арка с дверью, оплетена зелёными лианами и мхом, тёмная, без свечения | ![портал1.png](assets/asset_asset_10_портал1.png) |
| Тайный проход (открытый) | Игровая сцена (после открытия) | Финиш уровня | Да | Нужен | Каменная арка с дверью, оплетена зелёными лианами и мхом, тёмная, с свечением | ![портал2.jfif](assets/asset_asset_11_портал2.jfif) |
